...
for x in ['"Random"', '"Greedy"', '', '"greedy"']:
    ...
    response = requests.post(
        'https://europe-west1-neogamebackend.cloudfunctions.net/NeoGameGCP', headers=headers, data=data)
    print(response)
...
print(data)
response = requests.post(
    'https://europe-west1-neogamebackend.cloudfunctions.net/NeoGameGCP', headers=headers )
print(response)
print('Response time: ', response.elapsed.total_seconds())
try:
    print(response.json())
